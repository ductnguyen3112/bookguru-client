...
export default function Contact() {
  ...
  return (
    <div className="relative bg-white lg:h-screen lg:overflow-hidden">
      ...
      <div className="pt-12 pb-24 sm:pt-24 sm:pb-32 lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:pt-32 lg:h-full">
        {/* Right column: static header + scrollable form (lg+) */}
        <div className="px-6 lg:px-8 lg:h-full lg:flex lg:flex-col">
          ...
          <div className="mt-6 lg:flex-1 lg:overflow-y-auto lg:pr-1">
            <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
              <form action="#" method="POST" className="pb-8">
